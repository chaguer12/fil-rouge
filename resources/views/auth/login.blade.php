        ...
        <div class="md:flex w-full">
            ...
            <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                <div class="text-center mb-10">
                    ...
                    <p>Entrez votre informations pour s'enthentifier</p>
                </div>
                <div>
                    @if($errors->any())
                    ...
                    <form action="{{route('login')}}" method="POST">
                        ...
                        <div class="flex -mx-3">
                            <div class="w-full px-3 mb-5">
                                <button type="submit"
                                    class="block w-full max-w-xs mx-auto bg-[#428c9e] hover:shadow-lg text-white rounded-lg px-3 py-3 font-semibold">Login</button>
                            </div>
                        </div>
                    </form>
                </div>
...
<div class="flex items-end justify-end fixed bottom-0 right-0 mb-4 mr-4 z-10">
    <div>
        <a title="Buy me a beer" href="{{route('register-form')}}"
            class="block w-16 h-16 rounded-full transition-all shadow hover:shadow-lg transform hover:scale-110 hover:rotate-12">
            <h1 class="font-bold text-xl text-center text-gray-900">Register</h1>
        </a>
    </div>
</div>